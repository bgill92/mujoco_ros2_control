...
void MujocoSystemInterface::reset_simulation_state(bool /*fill_initial_state*/)
{
  ...
  // Notify plugins: they own runtime state (e.g. latched vacuum, activated welds) that the
  // world reset has invalidated. eq_active has already been restored to MJCF defaults.
  for (auto& plugin : plugin_instances_)
  {
